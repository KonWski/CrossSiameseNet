...
def get_dataset(dataset_name: str, splitter = None, cf_radius: int = 4, cf_size: int = 2048, 
    ...
    if triplet_loss:
        ...
        test_dataset = MolDatasetTriplet(X_test, y_test, smiles_test, False, use_fixed_triplets=True)
        valid_dataset = MolDatasetTriplet(X_val, y_val, smiles_val, False, use_fixed_triplets=True)
